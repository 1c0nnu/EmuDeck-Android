...
while true; do
   ...
   --radiolist "Move using your DPAD and select your platforms with the Y button. Press the A button to select." 10 80 4 \
	"EASY" "This is a 100% automatic mode. We will configure\n your device with the recommended settings so you can start playing right away." OFF \
	"CUSTOM" "This mode gives you a bit more of control on how EmuDeck\n configures your system. You will be able to configure Aspect Ratios, Bezels, Filters, RetroAchievments, Emulators, etc." OFF \
   3>&1 1<&2 2>&3)
	case $question in
		[EASY]* ) break;;
		[CUSTOM]* ) break;;
